  ...
  return (
    <Card className="max-w-2xl mx-auto">
      ...
      <CardContent className="p-6">
        <h3 className="text-lg font-semibold mb-6 prose prose-sm max-w-none"><RichContentRenderer content={currentQ.question} inline /></h3>
        <RadioGroup
        ...
        >
          {currentQ.options.map((option, idx) => (
            ...
            >
              ...
              <Label htmlFor={`option-${idx}`} className="cursor-pointer flex-1"><RichContentRenderer content={option} inline /></Label>
            </div>
          ))}
        </RadioGroup>
      </CardContent>
