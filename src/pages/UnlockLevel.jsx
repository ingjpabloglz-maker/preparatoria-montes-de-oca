...
export default function UnlockLevel() {
  ...
  const handleUnlockSuccess = async () => {
    // Delegar al backend: calcula expires_at con tiempo del servidor + LevelConfig
    await base44.functions.invoke('advanceToLevel', { level_number: levelNum });
    setTimeout(() => {
      ...
      <div className="flex-1 flex items-center justify-center p-6">
        {canUnlock ? (
          <div className="w-full max-w-lg space-y-6">
            {/* Requisito: todas las materias aprobadas */}
            <Card className="border-0 shadow-sm">
              <CardContent className="p-6 space-y-3">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <span className={prevLevelComplete ? "text-green-700" : "text-gray-600"}>
                    Todas las materias del Nivel {levelNum - 1} completadas y aprobadas
                  </span>
                </div>
              </CardContent>
            </Card>
            ...
            {prevLevelComplete ? (
              ...
              <div className="text-center py-4">
                <p className="text-amber-600 font-medium">
                  Debes aprobar todas las materias del Nivel {levelNum - 1} antes de ingresar tu folio de pago.
                </p>
                <Button 
                  className="mt-4" 
