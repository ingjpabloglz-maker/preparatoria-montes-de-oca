        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
            ...
            <div className="space-y-3">
              ...
              <p className="text-sm leading-relaxed px-3 mx-1">Desde hace más de 16 años nuestra finalidad como es impartir a los alumnos enseñanza a nivel Medio Superior para contribuir al desarrollo de México por medio de la preparación integral de sus estudiantes, capacitándolos a continuar con estudios profesionales y de calidad, orientados a su vocación.</p>
            </div>
