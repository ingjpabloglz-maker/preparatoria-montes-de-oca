      ...
      <section className="bg-slate-50 border-b border-slate-100 py-5">
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-6">
            {STATS.map((s) =>
            <div key={s.label} className="flex flex-col items-center text-center rounded-xl border border-slate-100 shadow-sm hover:shadow-md transition-shadow px-1 py-1 bg-orange-50">
