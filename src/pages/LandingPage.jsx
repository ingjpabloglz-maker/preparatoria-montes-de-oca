...
{ value: "Comunidad\nactiva", label: "Estudiantes activos", icon: Users },
...
export default function LandingPage() {
  ...
  return (
    <div className="min-h-screen bg-white flex flex-col font-sans">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:py-28 py-1">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="space-y-7">
              ...
              <p className="text-slate-300 text-lg leading-relaxed max-w-lg">Plataforma educativa oficial. Estudia en línea con reconocimiento y acompañamiento docente real.
              ...
              <p className="text-xs text-slate-500">
                ✓ En linea · ✓ Acceso inmediato 24/7· ✓ Soporte académico incluido
              </p>
            </div>

            {/* Logo derecha */}
            <div className="hidden lg:flex justify-center items-center">
              <img src="https://media.base44.com/images/public/69a88a8bf5baf0edfc4ac0c5/1aee2bfa4_logo_anterior.png" alt="Preparatoria Montes de Oca" className="w-72 h-72 object-cover shadow-2xl border-4 border-white/10 rounded-[48px]" loading="lazy" />
            </div>
          </div>
        </div>
      </section>
      ...
      {/* ─── CÓMO FUNCIONA ─── */}
      <section id="como-funciona" className="bg-white py-4">
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
      ...
      <section id="nosotros" className="bg-white py-2">
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {WHY_US.map((item, i) =>
            <div key={i} className="rounded-2xl border border-slate-100 hover:shadow-md transition-all hover:-translate-y-1 px-8 py-1 bg-[hsl(var(--background))]">
      ...
      <section className="bg-gradient-to-br from-blue-600 to-blue-700 text-white text-center py-4">
        <div className="max-w-3xl mx-auto px-4 space-y-6">
          ...
          <p className="text-blue-100 text-lg leading-relaxed">Únete a cientos de estudiantes que ya obtienen su bachillerato con validez oficial SEP desde cualquier lugar de Tamaulipas y lleva tu conocimiento a tu propio ritmo desde cualquier lugar.
